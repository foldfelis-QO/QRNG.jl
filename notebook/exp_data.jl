...
# ╔═╡ 85e239f0-286f-11ed-35ae-ade406e4d217
begin
	using CSV, DataFrames
	using Distributions, QuantumStateDistributions
	# using Plots
end

# ╔═╡ f114fce6-a4cb-4d4c-b4ba-9cb3bd50d616
begin
	df = CSV.read(
...
# ╔═╡ 3f8e43c9-b4d7-4b12-b114-fba5be0ee687
# scatter(xs)

# ╔═╡ 11fdf0d4-164d-4f2d-9c3d-05329522b539
d = fit(Normal, xs)

# ╔═╡ 5103523a-fb11-465c-bc2f-7094cc2b557d
begin
	t = 50
	ppit = PositivePreservingIterator(
		vcat(LinRange(0, 2π, length(xs))', xs'),
		t, dim=35
	)
	run!(ppit)
	ppit.ρ
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "8787a37e6638c669d0abc522cea8bf027fffab9c"
